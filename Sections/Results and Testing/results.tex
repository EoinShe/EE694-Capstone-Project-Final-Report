...
scan experiments, unstable or inconsistent parsed data readback can prevent
...
window. Similarly, the system does not perform full deep packet inspection or
stateful flow analysis, as it operates primarily on packet header fields.
This limits its ability to detect application-layer or evasion-based attacks.
...
\subsection{How the Results Compare}